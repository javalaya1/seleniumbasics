...
public class HowToSelectFromDropDown_Type_3_using_visible_Text {
...
//		select_country.selectByValue("INDIA"); //1 - 2nd value in dropdown - because index starts from 0
		select_country.selectByVisibleText("INDIA"); //1 - 2nd value in dropdown - because index starts from 0
