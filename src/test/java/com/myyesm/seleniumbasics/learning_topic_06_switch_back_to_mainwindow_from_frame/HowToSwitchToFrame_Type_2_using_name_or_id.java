...
public class HowToSwitchToFrame_Type_2_using_name_or_id {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//driver.switchTo().frame("iframeResult"); //switching to frame using name
		
		new WebDriverWait(driver, Duration.ofSeconds(120)).pollingEvery(Duration.ofSeconds(5)).ignoring(NoSuchFrameException.class)
		.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("iframeResult"));
